 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 58 08 00 00       	mov    $0x858,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 10 0b 00 00       	mov    0xb10,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 10 0b 00 00    	mov    0xb10,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 10 0b 00 00       	mov    0xb10,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 10 0b 00 00       	mov    %eax,0xb10
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 14 0b 00 00       	mov    $0xb14,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 7c2:	00 00 00 
    if(p->s.size >= nunits){
