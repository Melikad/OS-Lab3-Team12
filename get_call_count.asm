...
int main(int argc, char *argv[]){
  ...
  23:	51                   	push   %ecx
  24:	50                   	push   %eax
  25:	68 a8 08 00 00       	push   $0x8a8
  2a:	6a 01                	push   $0x1
  2c:	e8 0f 05 00 00       	call   540 <printf>
  ...
  40:	50                   	push   %eax
  41:	68 d0 08 00 00       	push   $0x8d0
  46:	6a 01                	push   $0x1
  48:	e8 f3 04 00 00       	call   540 <printf>
  ...
  62:	6a 01                	push   $0x1
  64:	e8 d7 04 00 00       	call   540 <printf>
      	  	printf(1, "\n-----------------------------------------------------------\n");
  69:	58                   	pop    %eax
  6a:	5a                   	pop    %edx
  ...
  97:	50                   	push   %eax
  98:	68 c8 09 00 00       	push   $0x9c8
  9d:	6a 01                	push   $0x1
  9f:	e8 9c 04 00 00       	call   540 <printf>
		    printf(1,"User: the number of times the system call SYS_write was called in second child process: %d\n" , get_call_count(SYS_write));
  ...
  f3:	50                   	push   %eax
  f4:	68 a8 0a 00 00       	push   $0xaa8
  f9:	6a 01                	push   $0x1
  fb:	e8 40 04 00 00       	call   540 <printf>
 ...
 10f:	50                   	push   %eax
 110:	68 cc 0a 00 00       	push   $0xacc
 115:	6a 01                	push   $0x1
 117:	e8 24 04 00 00       	call   540 <printf>
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 80 0b 00 00 	movzbl 0xb80(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb 79 0b 00 00       	mov    $0xb79,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 715:	a1 28 0e 00 00       	mov    0xe28,%eax
{
 ...
 736:	73 10                	jae    748 <free+0x38>
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	a3 28 0e 00 00       	mov    %eax,0xe28
}
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 769:	5d                   	pop    %ebp
 ...
 787:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 78a:	a3 28 0e 00 00       	mov    %eax,0xe28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7b0:	8b 3d 28 0e 00 00    	mov    0xe28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	8b 3d 28 0e 00 00    	mov    0xe28,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 28 0e 00 00       	mov    0xe28,%eax
 ...
 854:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 857:	a3 28 0e 00 00       	mov    %eax,0xe28
}
 ...
 86e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 28 0e 00 00 2c 	movl   $0xe2c,0xe28
 877:	0e 00 00 
    base.s.size = 0;
 87a:	bf 2c 0e 00 00       	mov    $0xe2c,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 2c 0e 00 00 2c 	movl   $0xe2c,0xe2c
 886:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 88b:	c7 05 30 0e 00 00 00 	movl   $0x0,0xe30
 892:	00 00 00 
    if(p->s.size >= nunits){
