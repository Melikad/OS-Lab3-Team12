...
00003a23 <set_proc_queue>:
SYSCALL(set_proc_queue)
    3a23:	b8 1a 00 00 00       	mov    $0x1a,%eax
    3a28:	cd 40                	int    $0x40
    3a2a:	c3                   	ret    

00003a2b <set_tickets>:
SYSCALL(set_tickets)
    3a2b:	b8 1b 00 00 00       	mov    $0x1b,%eax
    3a30:	cd 40                	int    $0x40
    3a32:	c3                   	ret    

00003a33 <set_bjf_params_in_proc>:
SYSCALL(set_bjf_params_in_proc)
    3a33:	b8 1c 00 00 00       	mov    $0x1c,%eax
    3a38:	cd 40                	int    $0x40
    3a3a:	c3                   	ret    

00003a3b <set_bjf_params_in_system>:
SYSCALL(set_bjf_params_in_system)
    3a3b:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3a40:	cd 40                	int    $0x40
    3a42:	c3                   	ret    

00003a43 <print_info>:
    3a43:	b8 1e 00 00 00       	mov    $0x1e,%eax
    3a48:	cd 40                	int    $0x40
    3a4a:	c3                   	ret    
