...
00000e33 <set_proc_queue>:
SYSCALL(set_proc_queue)
     e33:	b8 1a 00 00 00       	mov    $0x1a,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret    

00000e3b <set_tickets>:
SYSCALL(set_tickets)
     e3b:	b8 1b 00 00 00       	mov    $0x1b,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret    

00000e43 <set_bjf_params_in_proc>:
SYSCALL(set_bjf_params_in_proc)
     e43:	b8 1c 00 00 00       	mov    $0x1c,%eax
     e48:	cd 40                	int    $0x40
     e4a:	c3                   	ret    

00000e4b <set_bjf_params_in_system>:
SYSCALL(set_bjf_params_in_system)
     e4b:	b8 1d 00 00 00       	mov    $0x1d,%eax
     e50:	cd 40                	int    $0x40
     e52:	c3                   	ret    

00000e53 <print_info>:
     e53:	b8 1e 00 00 00       	mov    $0x1e,%eax
     e58:	cd 40                	int    $0x40
     e5a:	c3                   	ret    
