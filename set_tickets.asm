...
_set_tickets:     file format elf32-i386
  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  if(argc <= 2){
  1d:	7f 05                	jg     24 <main+0x24>
    exit();
  1f:	e8 8f 02 00 00       	call   2b3 <exit>
  }

  set_tickets(atoi(argv[1]), atoi(argv[2]));
  24:	83 ec 0c             	sub    $0xc,%esp
  27:	ff 76 08             	pushl  0x8(%esi)
  2a:	e8 11 02 00 00       	call   240 <atoi>
  2f:	89 c3                	mov    %eax,%ebx
  31:	58                   	pop    %eax
  32:	ff 76 04             	pushl  0x4(%esi)
  35:	e8 06 02 00 00       	call   240 <atoi>
  3a:	5a                   	pop    %edx
  3b:	59                   	pop    %ecx
  3c:	53                   	push   %ebx
  3d:	50                   	push   %eax
  3e:	e8 18 03 00 00       	call   35b <set_tickets>
  exit();
