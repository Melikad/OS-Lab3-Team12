 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 74 08 00 00 	movzbl 0x874(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb 6c 08 00 00       	mov    $0x86c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 645:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 666:	73 10                	jae    678 <free+0x38>
{
 ...
 691:	5b                   	pop    %ebx
  freep = p;
 692:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 697:	5e                   	pop    %esi
 698:	5f                   	pop    %edi
 699:	5d                   	pop    %ebp
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6e0:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 729:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
 ...
 752:	e8 e9 fe ff ff       	call   640 <free>
  return freep;
 757:	a1 1c 0b 00 00       	mov    0xb1c,%eax
 ...
 784:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 787:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 ...
 79e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 1c 0b 00 00 20 	movl   $0xb20,0xb1c
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	bf 20 0b 00 00       	mov    $0xb20,%edi
    base.s.ptr = freep = prevp = &base;
 7af:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7b6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7b9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7bb:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7c2:	00 00 00 
    if(p->s.size >= nunits){
