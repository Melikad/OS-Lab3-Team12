...
_set_bjf_system:     file format elf32-i386
...
00000373 <set_proc_queue>:
SYSCALL(set_proc_queue)
 373:	b8 1a 00 00 00       	mov    $0x1a,%eax
 378:	cd 40                	int    $0x40
 37a:	c3                   	ret    

0000037b <set_tickets>:
SYSCALL(set_tickets)
 37b:	b8 1b 00 00 00       	mov    $0x1b,%eax
 380:	cd 40                	int    $0x40
 382:	c3                   	ret    

00000383 <set_bjf_params_in_proc>:
SYSCALL(set_bjf_params_in_proc)
 383:	b8 1c 00 00 00       	mov    $0x1c,%eax
 388:	cd 40                	int    $0x40
 38a:	c3                   	ret    

0000038b <set_bjf_params_in_system>:
SYSCALL(set_bjf_params_in_system)
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb c6 07 00 00       	mov    $0x7c6,%ebx
        while(*s != 0){
